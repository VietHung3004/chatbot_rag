...
from src.config import OPENAI_API_KEY, EMBEDDING_MODEL, FAISS_Products


def build_products_faiss():
    ...
    vectorstore.save_local(FAISS_Products)

    print("✅ FAISS_PRODUCTS saved successfully!")


if __name__ == "__main__":
    build_products_faiss()